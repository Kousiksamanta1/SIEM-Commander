...
## Good GitHub / CV Positioning

Use honest wording like:

`Built a PyQt6 SOC analyst console that integrates with a live Wazuh deployment, retrieves agent health through the Wazuh API, queries recent alerts from the Wazuh indexer, and supports dashboard navigation and service health validation.`

That is much stronger than claiming you built a full SIEM from scratch.
